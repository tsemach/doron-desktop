...
7. Show detailed query-by-query analysis of a specific run (e.g. Run ID #1) directly:
   $ cargo run --bin eval show 1

8. Show detailed query-by-query analysis of a specific run from a custom database:
