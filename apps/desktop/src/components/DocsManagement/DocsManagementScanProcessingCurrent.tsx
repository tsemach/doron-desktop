  ...
  return (
    <div className="flex items-center gap-3 mx-6 mt-4 p-3 rounded-lg border border-blue-100 bg-blue-50/40 font-mono text-xs text-blue-900 min-h-[58px]">
      ...
      <div className="flex-1 min-w-0">
        <p className="font-bold truncate">{currentItem?.file_name || "Indexing in progress..."}</p>
        <p className="text-blue-700 text-[10px] mt-0.5">{currentItem?.message || "Analyzing documents..."}</p>
      </div>
    </div>
  );
}
