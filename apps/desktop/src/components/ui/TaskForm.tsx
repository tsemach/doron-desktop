        ...
        {mode === "edit" && (
          <div className="space-y-1.5">
            ...
            <select
              ...
              className="w-full rounded-md border border-input bg-background px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-ring transition-all cursor-pointer"
              disabled={submitting}
            >
