...
export default function TaskTemplateDeleteWarningModal({
  templateName,
  onConfirm,
  onCancel,
      ...
      <div className="w-full max-w-md bg-card border border-border rounded-lg shadow-2xl p-6 space-y-6 animate-in zoom-in-95 duration-200">
        <div className="flex items-start gap-4">
          ...
          <div className="space-y-1.5">
            <h3 className="text-lg font-bold text-foreground">Delete Task Template?</h3>
            <p className="text-sm text-muted-foreground leading-normal">
              Are you sure you want to delete the task template <strong className="text-foreground">"{templateName}"</strong>?
              This will permanently delete this template and its tasks configuration and cannot be undone. Cases that already used this template keep their existing tasks.
            </p>
          </div>
        </div>
