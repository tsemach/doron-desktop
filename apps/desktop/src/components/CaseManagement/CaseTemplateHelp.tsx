    ...
    <div className="rounded-xl border border-border/80 bg-card p-5 shadow-lg animate-in fade-in slide-in-from-top-2 duration-300 min-w-0 space-y-5 relative overflow-y-auto max-h-full h-full text-foreground flex flex-col">
      ...
      <div className="space-y-3 pb-2 shrink-0">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 relative">
          {/* STEP 1 */}
          <div className="group relative rounded-xl border border-blue-500/20 bg-gradient-to-b from-blue-500/5 to-transparent p-4 flex flex-col justify-between transition-all duration-200 hover:border-blue-500/40 hover:shadow-md">
            <div className="space-y-3">
              {/* Step Circle Header */}
              <div className="flex items-center gap-3">
                <div className="size-8 rounded-full bg-blue-600 text-white font-black text-sm flex items-center justify-center shadow-md shadow-blue-500/20 group-hover:scale-110 transition-transform">
                  1
                </div>
                <div>
                  <h5 className="font-bold text-sm text-foreground flex items-center gap-1.5">
                    {/* FileText Icon */}
                    <svg className="w-4 h-4 text-blue-600 dark:text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <div className="bg-background/80 rounded-lg p-2.5 border border-border/80 space-y-1.5">
                <span className="text-[10px] uppercase font-bold tracking-wider text-muted-foreground block">
                  Example Placeholders:
                </span>
                <div className="flex flex-wrap gap-1.5">
                  <code className="text-[11px] font-mono font-bold bg-blue-500/10 text-blue-600 dark:text-blue-300 px-2 py-0.5 rounded border border-blue-500/20">
                    {"{{ full-name }}"}
                  </code>
                  <code className="text-[11px] font-mono font-bold bg-blue-500/10 text-blue-600 dark:text-blue-300 px-2 py-0.5 rounded border border-blue-500/20">
                    {"{{ id_number }}"}
            ...
            <div className="hidden md:flex absolute -right-3 top-1/2 -translate-y-1/2 z-10 size-6 rounded-full bg-card border border-border text-muted-foreground items-center justify-center shadow-sm">
              <svg className="w-3.5 h-3.5 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          {/* STEP 2 */}
          <div className="group relative rounded-xl border border-indigo-500/20 bg-gradient-to-b from-indigo-500/5 to-transparent p-4 flex flex-col justify-between transition-all duration-200 hover:border-indigo-500/40 hover:shadow-md">
            <div className="space-y-3">
              {/* Step Circle Header */}
              <div className="flex items-center gap-3">
                <div className="size-8 rounded-full bg-indigo-600 text-white font-black text-sm flex items-center justify-center shadow-md shadow-indigo-500/20 group-hover:scale-110 transition-transform">
                  2
                </div>
                <div>
                  <h5 className="font-bold text-sm text-foreground flex items-center gap-1.5">
                    {/* Layers Icon */}
                    <svg className="w-4 h-4 text-indigo-600 dark:text-indigo-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          {/* STEP 3 */}
          <div className="group relative rounded-xl border border-emerald-500/20 bg-gradient-to-b from-emerald-500/5 to-transparent p-4 flex flex-col justify-between transition-all duration-200 hover:border-emerald-500/40 hover:shadow-md">
            <div className="space-y-3">
              {/* Step Circle Header */}
              <div className="flex items-center gap-3">
                <div className="size-8 rounded-full bg-emerald-600 text-white font-black text-sm flex items-center justify-center shadow-md shadow-emerald-500/20 group-hover:scale-110 transition-transform">
                  3
                </div>
                <div>
                  <h5 className="font-bold text-sm text-foreground flex items-center gap-1.5">
                    {/* CheckCircle Icon */}
                    <svg className="w-4 h-4 text-emerald-600 dark:text-emerald-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
