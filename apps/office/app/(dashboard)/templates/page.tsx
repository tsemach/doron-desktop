...
// Copied from apps/backend/app/templates/page.tsx (not shared/imported --
// apps/backend's copy will be deleted once this one fully replaces it, but
// not yet). MainTopBar/session/tier chrome dropped since the (dashboard)
// route group's layout already provides the sidebar + user menu.
