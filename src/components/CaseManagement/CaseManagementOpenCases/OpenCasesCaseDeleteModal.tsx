...
export default function OpenCasesCaseDeleteModal({
  caseSubject,
  onConfirm,
  onCancel,
      ...
      <div className="bg-card border border-border rounded-xl shadow-2xl flex flex-col animate-in zoom-in-95 duration-200 overflow-hidden relative w-[460px] p-6">
        <div className="flex items-start gap-4">
          ...
          <div className="space-y-1.5 flex-1 min-w-0">
            <h3 className="text-base font-bold text-foreground leading-tight">Delete Case</h3>
            <p className="text-xs text-muted-foreground">
              Are you sure you want to delete the case <span className="font-semibold text-foreground/90">"{caseSubject}"</span>?
            </p>
            <p className="text-xs text-muted-foreground mt-2">
              This action will mark the case as deleted in the database.
            </p>
          </div>
        </div>
